...
const AboutPage = () => {
  ...
  const [teamMembers, setTeamMembers] = useState([
    { id: '1', name: 'John Doe', role: 'CEO & Founder', imageUrl: '', linkedinUrl: '' },
    { id: '2', name: 'Jane Smith', role: 'CTO', imageUrl: '', linkedinUrl: '' },
    { id: '3', name: 'Mike Johnson', role: 'Head of Operations', imageUrl: '', linkedinUrl: '' }
  ]);
  ...
  return (
    <div className="about-page">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold contrast-text-light">About Content Management</h1>
        <button 
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-gray-800 p-6 rounded-lg shadow">
          <h2 className="text-lg font-semibold mb-4 contrast-text-light">Editor</h2>
          <div className="mb-4">
            ...
            <p className="text-xs contrast-text-gray mt-1">
              You can use HTML tags to format the content. Content will be sanitized before saving.
            </p>
          </div>
        </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold contrast-text-light">Team Members</h2>
          <button 
            ...
            <div key={member.id} className="bg-gray-700 p-4 rounded-md">
              ...
              <div className="mb-3">
                ...
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) => handleImageUpload(e.target.files[0], member.id)}
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) => handleTeamMemberChange(member.id, 'linkedinUrl', e.target.value)}
                  className="w-full px-2 py-1 text-sm border border-gray-600 rounded bg-gray-600 contrast-text-light"
