...
const InstructorSection = () => {
  ...
  return (
    <section className="instructor-section py-2 md:py-16 bg-black relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
          ...
          <div className="w-full md:w-1/2 text-left animate-slideInLeft">
            <div className="inline-block px-5 py-2 rounded-full bg-red-900/20 border border-red-500/30 text-red-400 text-xs font-bold tracking-widest uppercase mb-4 md:mb-8 backdrop-blur-sm">
              Meet Your Instructor
            </div>
            <h2 className="text-3xl md:text-7xl font-extrabold text-white mb-4 md:mb-8 leading-tight tracking-tight">
              The Architect of <br />
            ...
            <div className="relative mb-6 md:mb-10">
              ...
              <p className="text-gray-300 text-sm md:text-xl leading-relaxed pl-6 border-l-4 border-red-600/80 italic font-light">
                {bio}
              </p>
            </div>

            {/* Hidden on mobile, moved to profile card */}
          ...
          <div className="w-full md:w-1/2 relative animate-slideInRight">
            <div className="relative z-10">
              ...
              {/* Floating Name Card */}
              <div className="absolute bottom-4 right-0 md:bottom-10 z-20 bg-gray-900 bg-opacity-90 backdrop-blur-md p-3 md:p-4 rounded-lg border border-gray-700 shadow-xl flex items-center gap-3 animate-bounce-slow max-w-[80%] md:max-w-none">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full overflow-hidden border border-gray-600 flex-shrink-0">
                  {imageUrl && (
                    <img
                      src={imageUrl}
                      alt="Profile"
                ...
                <div className="flex-grow">
                  <h4 className="text-white font-bold text-xs md:text-sm">{name}</h4>
                  <p className="text-[10px] md:text-xs text-gray-400">{title}</p>
                </div>
                {/* LinkedIn Icon Integrated */}
