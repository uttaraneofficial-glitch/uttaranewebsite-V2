...
router.post('/companies', upload_1.upload.single('image'), companies_controller_1.createCompany);
router.put('/companies/:id', upload_1.upload.single('image'), companies_controller_1.updateCompany);
...
router.post('/videos', upload_1.upload.single('image'), videos_controller_1.createVideo);
router.put('/videos/:id', upload_1.upload.single('image'), videos_controller_1.updateVideo);
...
router.post('/candidates', upload_1.upload.single('image'), candidates_controller_1.createCandidate);
router.put('/candidates/:id', upload_1.upload.single('image'), candidates_controller_1.updateCandidate);
...
router.post('/ngo-posts', upload_1.upload.single('image'), ngo_posts_controller_1.createNgoPost);
router.put('/ngo-posts/:id', upload_1.upload.single('image'), ngo_posts_controller_1.updateNgoPost);
...
router.post('/mkstudio-posts', upload_1.upload.single('image'), mkstudio_posts_controller_1.createMkStudioPost);
router.put('/mkstudio-posts/:id', upload_1.upload.single('image'), mkstudio_posts_controller_1.updateMkStudioPost);
...
router.put('/site-content/:key', upload_1.upload.single('image'), site_content_controller_1.updateSiteContent);
