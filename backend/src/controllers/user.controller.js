...
var changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, currentPassword, newPassword, user, isValidPassword, hashedPassword, error_1;
    var _b;
        ...
        switch (_c.label) {
            case 0:
                ...
                _a = zod_1.z
                    ...
                    .parse(req.body), currentPassword = _a.currentPassword, newPassword = _a.newPassword;
            ...
            case 5:
                error_1 = _c.sent();
                console.error('Password change error:', error_1);
